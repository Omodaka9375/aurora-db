const AuroraDB = (function () {
  ...
  function $5151b78094cea2ba$export$cf133661e444ccfe(window) {
      ...
      window.RTCIceCandidate = function RTCIceCandidate(args) {
          ...
          if (args.candidate && args.candidate.length) {
              ...
              const parsedCandidate = ((/*@__PURE__*/$parcel$interopDefault($5d0e6002f6ec24ec$exports))).parseCandidate(args.candidate);
  ...
  function $5151b78094cea2ba$export$fdafb8d8280e29b5(window) {
      ...
      $9fea4db837311579$export$1f48841962b828b1(window, 'icecandidate', (e)=>{
          if (e.candidate) {
              const parsedCandidate = ((/*@__PURE__*/$parcel$interopDefault($5d0e6002f6ec24ec$exports))).parseCandidate(e.candidate.candidate);
  ...
  function $5151b78094cea2ba$export$a99147c78a56edc4(window, browserDetails) {
      ...
      const sctpInDescription = function(description) {
          ...
          const sections = ((/*@__PURE__*/$parcel$interopDefault($5d0e6002f6ec24ec$exports))).splitSections(description.sdp);
          sections.shift();
          return sections.some((mediaSection)=>{
              const mLine = ((/*@__PURE__*/$parcel$interopDefault($5d0e6002f6ec24ec$exports))).parseMLine(mediaSection);
      ...
      const getMaxMessageSize = function(description, remoteIsFirefox) {
          ...
          const match = ((/*@__PURE__*/$parcel$interopDefault($5d0e6002f6ec24ec$exports))).matchPrefix(description.sdp, 'a=max-message-size:');
  ...
  function $b657217e95eb14d8$export$e77bf46c04ac7d12({ window: window } = {}, options = {
      ...
      switch(browserDetails.browser){
          case 'chrome':
              ...
              $5151b78094cea2ba$export$7170d04e59f9d553(window);
              ...
              $5151b78094cea2ba$export$cf133661e444ccfe(window);
              $5151b78094cea2ba$export$fdafb8d8280e29b5(window);
              $5151b78094cea2ba$export$63bb816cc75460(window);
              $5151b78094cea2ba$export$a99147c78a56edc4(window, browserDetails);
              $5151b78094cea2ba$export$d461c8d5c5db5da7(window);
  ...
  const $90c50c10bd6fa8b4$var$adapter = ($b657217e95eb14d8$export$e77bf46c04ac7d12)({
  ...
  ($90c50c10bd6fa8b4$export$2e2bcd8739ae039).default || ($90c50c10bd6fa8b4$export$2e2bcd8739ae039);
  ...
  class $01f0d223090cb1f8$export$f8f26dd395d7e1bd extends ($616ebdf1c4998439$export$f1c5f4c9cb95390b) {
      noop() {}
      ...
      constructor(...args){
          ...
          this.defaultConfig = $01f0d223090cb1f8$var$DEFAULT_CONFIG, this.browser = ($a9bc9397a7d36afa$export$25be9502477c137d).getBrowser(), this.browserVersion = ($a9bc9397a7d36afa$export$25be9502477c137d).getVersion(), this.pack = $bf7fb46c6d68ead7$export$2a703dbb0cb35339, this.unpack = $bf7fb46c6d68ead7$export$417857010dc9287f, /**
  	 ...
  	 */ this.supports = function() {
              const supported = {
                  browser: ($a9bc9397a7d36afa$export$25be9502477c137d).isBrowserSupported(),
                  webRTC: ($a9bc9397a7d36afa$export$25be9502477c137d).isWebRTCSupported(),
                  audioVideo: false,
                  data: false,
                  binaryBlob: false,
                  reliable: false
          ...
          this.validateId = ($fce54fbdd74b2319$export$f35f128fd59ea256), this.randomToken = ($008766fe99f03c2f$export$4e61f672936bec77);
      }
  }
  ...
  class $5dd3b97502a89fbb$export$4798917dbf149b79 extends ($f5d7fbd88de797fd$exports.EventEmitter) {
      start(id, token) {
          this._id = id;
          const wsUrl = `${this._baseUrl}&id=${id}&token=${token}`;
          if (!!this._socket || !this._disconnected) return;
          this._socket = new WebSocket(wsUrl + "&version=" + ($580fed67ed3c559d$exports.version));
          ...
          this._socket.onmessage = (event)=>{
              ...
              try {
                  ...
                  ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Invalid server message", event.data);
                  return;
              }
              this.emit(($edbcf3072a01d580$export$3b5c4a4b6354f023).Message, data);
          };
          this._socket.onclose = (event)=>{
              if (this._disconnected) return;
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Socket closed.", event);
              this._cleanup();
              this._disconnected = true;
              this.emit(($edbcf3072a01d580$export$3b5c4a4b6354f023).Disconnected);
          };
          ...
          this._socket.onopen = ()=>{
              ...
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Socket open");
      ...
      _sendHeartbeat() {
          if (!this._wsOpen()) {
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`Cannot send heartbeat, because socket closed`);
              return;
          }
          const message = JSON.stringify({
              type: ($edbcf3072a01d580$export$adb4a1754da6f10d).Heartbeat
          });
      ...
      /** Exposed send for DC & Peer. */ send(data) {
          ...
          if (!data.type) {
              this.emit(($edbcf3072a01d580$export$3b5c4a4b6354f023).Error, "Invalid message");
              return;
          }
  ...
  class $3cabb799c2437cbe$export$89e6bb5ad64bf4a {
      /** Returns a PeerConnection object set up correctly (for data, media). */ startConnection(options) {
          ...
          if (this.connection.type === ($edbcf3072a01d580$export$3157d57b4135e3bc).Media && options._stream) this._addTracksToConnection(options._stream, peerConnection);
      ...
      /** Start a PC. */ _startPeerConnection() {
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Creating RTCPeerConnection.");
      ...
      /** Set up various WebRTC listeners. */ _setupListeners(peerConnection) {
          ...
          // ICE CANDIDATES.
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Listening for ICE candidates.");
          peerConnection.onicecandidate = (evt)=>{
              if (!evt.candidate || !evt.candidate.candidate) return;
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`Received ICE candidates for ${peerId}:`, evt.candidate);
              provider.socket.send({
                  type: ($edbcf3072a01d580$export$adb4a1754da6f10d).Candidate,
                  payload: {
          ...
          peerConnection.oniceconnectionstatechange = ()=>{
              switch(peerConnection.iceConnectionState){
                  case "failed":
                      ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("iceConnectionState is failed, closing connections to " + peerId);
                      this.connection.emitError(($edbcf3072a01d580$export$7974935686149686).NegotiationFailed, "Negotiation of connection to " + peerId + " failed.");
                      this.connection.close();
                      break;
                  case "closed":
                      ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("iceConnectionState is closed, closing connections to " + peerId);
                      this.connection.emitError(($edbcf3072a01d580$export$7974935686149686).ConnectionClosed, "Connection to " + peerId + " closed.");
                      this.connection.close();
                      break;
                  case "disconnected":
                      ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("iceConnectionState changed to disconnected on the connection with " + peerId);
                      break;
                  case "completed":
          ...
          // DATACONNECTION.
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Listening for data channel");
          // Fired between offer and answer, so options should already be saved
          // in the options hash.
          peerConnection.ondatachannel = (evt)=>{
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Received data channel");
              const dataChannel = evt.channel;
              const connection = provider.getConnection(peerId, connectionId);
              connection._initializeDataChannel(dataChannel);
          };
          // MEDIACONNECTION.
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Listening for remote stream");
          peerConnection.ontrack = (evt)=>{
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Received remote stream");
              const stream = evt.streams[0];
              const connection = provider.getConnection(peerId, connectionId);
              if (connection.type === ($edbcf3072a01d580$export$3157d57b4135e3bc).Media) {
      ...
      cleanup() {
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Cleaning up PeerConnection to " + this.connection.peer);
      ...
      async _makeOffer() {
          ...
          try {
              ...
              provider.emitError(($edbcf3072a01d580$export$9547aaa2e39030ff).WebRTC, err_1);
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Failed to createOffer, ", err_1);
          }
      }
      async _makeAnswer() {
          const peerConnection = this.connection.peerConnection;
          ...
          try {
              ...
              provider.emitError(($edbcf3072a01d580$export$9547aaa2e39030ff).WebRTC, err_1);
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Failed to create answer, ", err_1);
          }
      }
      /** Handle an SDP. */ async handleSDP(type, sdp) {
          ...
          const peerConnection = this.connection.peerConnection;
          const provider = this.connection.provider;
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Setting remote description", sdp);
          const self = this;
          try {
              ...
              provider.emitError(($edbcf3072a01d580$export$9547aaa2e39030ff).WebRTC, err);
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Failed to setRemoteDescription, ", err);
          }
      }
      /** Handle a candidate. */ async handleCandidate(ice) {
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`handleCandidate:`, ice);
          try {
              await this.connection.peerConnection.addIceCandidate(ice);
              (0, $d3fc3aacca52312c$export$2e2bcd8739ae039).log(`Added ICE candidate for:${this.connection.peer}`);
          } catch (err) {
              this.connection.provider.emitError(($edbcf3072a01d580$export$9547aaa2e39030ff).WebRTC, err);
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Failed to handleCandidate, ", err);
          }
      }
      _addTracksToConnection(stream, peerConnection) {
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`add tracks from stream ${stream.id} to peer connection`);
          if (!peerConnection.addTrack) return ($d3fc3aacca52312c$export$2e2bcd8739ae039).error(`Your browser does't support RTCPeerConnection#addTrack. Ignored.`);
          stream.getTracks().forEach((track)=>{
              peerConnection.addTrack(track, stream);
          });
      }
      _addStreamToMediaConnection(stream, mediaConnection) {
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`add stream ${stream.id} to media connection ${mediaConnection.connectionId}`);
  ...
  class $41eb28b5735ed6cf$export$6a678e589c8a4542 extends ($f5d7fbd88de797fd$exports.EventEmitter) {
      /**
  	 * Emits a typed error message.
  	 *
  	 * @internal
  	 */ emitError(type, err) {
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).error("Error:", err);
          // @ts-ignore
  ...
  class $f06f075a81a8b63e$export$23a2a68283c24d80 extends ($41eb28b5735ed6cf$export$6a678e589c8a4542) {
      /**
  ...
  class $0bc12d7ac26e1491$export$4a84e95a2324ac29 extends ($f06f075a81a8b63e$export$23a2a68283c24d80) {
      /**
  	 * For media connections, this is always 'media'.
  	 */ get type() {
          return ($edbcf3072a01d580$export$3157d57b4135e3bc).Media;
      }
      get localStream() {
      ...
      /** Called by the Negotiator when the DataChannel is ready. */ _initializeDataChannel(dc) {
          ...
          this.dataChannel.onopen = ()=>{
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`DC#${this.connectionId} dc connection success`);
              this.emit("willCloseOnRemote");
          };
          this.dataChannel.onclose = ()=>{
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`DC#${this.connectionId} dc closed for:`, this.peer);
              this.close();
          };
      }
      addStream(remoteStream) {
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log("Receiving stream", remoteStream);
  	 ...
  	 */ handleMessage(message) {
          ...
          switch(message.type){
              case ($edbcf3072a01d580$export$adb4a1754da6f10d).Answer:
                  // Forward to negotiator
                  this._negotiator.handleSDP(type, payload.sdp);
                  this._open = true;
                  break;
              case ($edbcf3072a01d580$export$adb4a1754da6f10d).Candidate:
                  this._negotiator.handleCandidate(payload.candidate);
                  break;
              default:
                  ($d3fc3aacca52312c$export$2e2bcd8739ae039).warn(`Unrecognized message type:${type} from peer:${this.peer}`);
                  break;
          }
      }
      /**
       ...
       */ answer(stream, options = {}) {
          if (this._localStream) {
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).warn("Local stream already exists on this MediaConnection. Are you answering a call twice?");
              return;
          }
      ...
      constructor(peerId, provider, options){
          ...
          this.connectionId = this.options.connectionId || $0bc12d7ac26e1491$export$4a84e95a2324ac29.ID_PREFIX + ($01f0d223090cb1f8$export$7debb50ef11d5e0b).randomToken();
          this._negotiator = new ($3cabb799c2437cbe$export$89e6bb5ad64bf4a)(this);
  ...
  class $4c932c6613316196$export$2c4e825dc9120f87 {
      _buildRequest(method) {
          ...
          url.searchParams.set("version", ($580fed67ed3c559d$exports.version));
      ...
      /** Get a unique ID from the server via XHR and initialize with it. */ async retrieveId() {
          try {
              ...
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).error("Error retrieving ID", error);
              let pathError = "";
              if (this._options.path === "/" && this._options.host !== ($01f0d223090cb1f8$export$7debb50ef11d5e0b).CLOUD_HOST) pathError = " If you passed in a `path` to your self-hosted PeerServer, you'll also need to pass in that same path when creating a new Peer.";
      ...
      /** @deprecated */ async listAllPeers() {
          try {
              ...
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).error("Error retrieving list peers", error);
  ...
  class $392ccce28b647101$export$d365f7ad9d7df9c9 extends ($f06f075a81a8b63e$export$23a2a68283c24d80) {
      get type() {
          return ($edbcf3072a01d580$export$3157d57b4135e3bc).Data;
      }
      /** Called by the Negotiator when the DataChannel is ready. */ _initializeDataChannel(dc) {
          this.dataChannel = dc;
          this.dataChannel.onopen = ()=>{
          ...
          this.dataChannel.onmessage = (e)=>{
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`DC#${this.connectionId} dc onmessage:`, e.data);
      ...
      /** Allows user to send data. */ send(data, chunked = false) {
          if (!this.open) {
              this.emitError(($edbcf3072a01d580$export$49ae800c114df41d).NotOpenYet, "Connection is not open. You should listen for the `open` event before sending messages.");
              return;
          }
      ...
      async handleMessage(message) {
          ...
          switch(message.type){
              ...
              case ($edbcf3072a01d580$export$adb4a1754da6f10d).Candidate:
                  ...
                  break;
              default:
                  ($d3fc3aacca52312c$export$2e2bcd8739ae039).warn("Unrecognized message type:", message.type, "from peer:", this.peer);
                  break;
          }
      }
      constructor(peerId, provider, options){
          super(peerId, provider, options);
          this.connectionId = this.options.connectionId || $392ccce28b647101$export$d365f7ad9d7df9c9.ID_PREFIX + ($008766fe99f03c2f$export$4e61f672936bec77)();
  ...
  class $8d1d5e45d8d6520c$export$ff7c9d4c11d94e8b extends ($392ccce28b647101$export$d365f7ad9d7df9c9) {
      get bufferSize() {
      ...
      _trySend(msg) {
          ...
          if (this.dataChannel.bufferedAmount > ($392ccce28b647101$export$d365f7ad9d7df9c9).MAX_BUFFERED_AMOUNT) {
          ...
          try {
              ...
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).error(`DC#:${this.connectionId} Error when sending:`, e);
              this._buffering = true;
              this.close();
              return false;
          }
  ...
  class $6b2c8b37149b9a13$export$f0a5a64d5bb37108 extends ($8d1d5e45d8d6520c$export$ff7c9d4c11d94e8b) {
      close(options) {
          super.close(options);
          this._chunkedData = {};
      }
      ...
      _handleDataMessage({ data: data }) {
          const deserializedData = ($bf7fb46c6d68ead7$export$417857010dc9287f)(data);
      ...
      _handleChunk(data) {
          ...
          if (chunkInfo.total === chunkInfo.count) {
              ...
              const data = ($616ebdf1c4998439$export$52c89ebcdc4f53f2)(chunkInfo.data);
      ...
      _send(data, chunked) {
          const blob = ($bf7fb46c6d68ead7$export$2a703dbb0cb35339)(data);
      ...
      _sendChunks(blob) {
          ...
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`DC#${this.connectionId} Try to send ${blobs.length} chunks...`);
          for (const blob of blobs)this.send(blob, true);
      }
      constructor(peerId, provider, options){
          super(peerId, provider, options), this.chunker = new ($616ebdf1c4998439$export$f1c5f4c9cb95390b)(), this.serialization = ($edbcf3072a01d580$export$89f507cf986a947).Binary, this._chunkedData = {};
      }
  }
  ...
  class $6faa8477ae391a66$export$6f88fe47d32c9c94 extends ($8d1d5e45d8d6520c$export$ff7c9d4c11d94e8b) {
      _handleDataMessage({ data: data }) {
      ...
      constructor(...args){
          super(...args), this.serialization = ($edbcf3072a01d580$export$89f507cf986a947).None;
      }
  }
  ...
  class $b524315f5ff1ee78$export$48880ac635f47186 extends ($8d1d5e45d8d6520c$export$ff7c9d4c11d94e8b) {
      // Handles a DataChannel message.
      _handleDataMessage({ data: data }) {
      ...
      _send(data, _chunked) {
          ...
          if (encodedData.byteLength >= ($01f0d223090cb1f8$export$7debb50ef11d5e0b).chunkedMTU) {
              this.emitError(($edbcf3072a01d580$export$49ae800c114df41d).MessageToBig, "Message too big for JSON channel");
              return;
          }
          this._bufferedSend(encodedData);
      }
      constructor(...args){
          super(...args), this.serialization = ($edbcf3072a01d580$export$89f507cf986a947).JSON, this.encoder = new TextEncoder(), this.decoder = new TextDecoder(), this.stringify = JSON.stringify, this.parse = JSON.parse;
      }
  }
  class $11967427976ce06d$export$ecd1fc136c422448 extends ($41eb28b5735ed6cf$export$6a678e589c8a4542) {
      /**
      ...
      _createServerConnection() {
          const socket = new ($5dd3b97502a89fbb$export$4798917dbf149b79)(this._options.secure, this._options.host, this._options.port, this._options.path, this._options.key, this._options.pingInterval);
          socket.on(($edbcf3072a01d580$export$3b5c4a4b6354f023).Message, (data)=>{
              this._handleMessage(data);
          });
          socket.on(($edbcf3072a01d580$export$3b5c4a4b6354f023).Error, (error)=>{
              this._abort(($edbcf3072a01d580$export$9547aaa2e39030ff).SocketError, error);
          });
          socket.on(($edbcf3072a01d580$export$3b5c4a4b6354f023).Disconnected, ()=>{
              if (this.disconnected) return;
              this.emitError(($edbcf3072a01d580$export$9547aaa2e39030ff).Network, "Lost connection to server.");
              this.disconnect();
          });
          socket.on(($edbcf3072a01d580$export$3b5c4a4b6354f023).Close, ()=>{
              if (this.disconnected) return;
              this._abort(($edbcf3072a01d580$export$9547aaa2e39030ff).SocketClosed, "Underlying socket is already closed.");
          });
          return socket;
      }
      ...
      /** Handles messages from the server. */ _handleMessage(message) {
          ...
          switch(type){
              case ($edbcf3072a01d580$export$adb4a1754da6f10d).Open:
                  this._lastServerId = this.id;
                  this._open = true;
                  this.emit("open", this.id);
                  break;
              case ($edbcf3072a01d580$export$adb4a1754da6f10d).Error:
                  this._abort(($edbcf3072a01d580$export$9547aaa2e39030ff).ServerError, payload.msg);
                  break;
              case ($edbcf3072a01d580$export$adb4a1754da6f10d).IdTaken:
                  this._abort(($edbcf3072a01d580$export$9547aaa2e39030ff).UnavailableID, `ID "${this.id}" is taken`);
                  break;
              case ($edbcf3072a01d580$export$adb4a1754da6f10d).InvalidKey:
                  this._abort(($edbcf3072a01d580$export$9547aaa2e39030ff).InvalidKey, `API KEY "${this._options.key}" is invalid`);
                  break;
              case ($edbcf3072a01d580$export$adb4a1754da6f10d).Leave:
                  ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`Received leave message from ${peerId}`);
                  this._cleanupPeer(peerId);
                  this._connections.delete(peerId);
                  break;
              case ($edbcf3072a01d580$export$adb4a1754da6f10d).Expire:
                  this.emitError(($edbcf3072a01d580$export$9547aaa2e39030ff).PeerUnavailable, `Could not connect to peer ${peerId}`);
                  break;
              case ($edbcf3072a01d580$export$adb4a1754da6f10d).Offer:
                  {
                      ...
                      if (connection) {
                          connection.close();
                          ($d3fc3aacca52312c$export$2e2bcd8739ae039).warn(`Offer received for existing Connection ID:${connectionId}`);
                      }
                      // Create a new connection.
                      if (payload.type === ($edbcf3072a01d580$export$3157d57b4135e3bc).Media) {
                          const mediaConnection = new ($0bc12d7ac26e1491$export$4a84e95a2324ac29)(peerId, this, {
                              connectionId: connectionId,
                              _payload: payload,
                      ...
                      } else if (payload.type === ($edbcf3072a01d580$export$3157d57b4135e3bc).Data) {
                          ...
                          ($d3fc3aacca52312c$export$2e2bcd8739ae039).warn(`Received malformed connection type:${payload.type}`);
                          return;
                      }
                      // Find messages.
              ...
              default:
                  {
                      if (!payload) {
                          ($d3fc3aacca52312c$export$2e2bcd8739ae039).warn(`You received a malformed message from ${peerId} of type ${type}`);
                          return;
                      }
                      const connectionId = payload.connectionId;
                      ...
                      else ($d3fc3aacca52312c$export$2e2bcd8739ae039).warn("You received an unrecognized message:", message);
                      break;
                  }
          }
      }
  	 ...
  	 */ connect(peer, options = {}) {
          ...
          if (this.disconnected) {
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect, or call reconnect on this peer if you believe its ID to still be available.");
              this.emitError(($edbcf3072a01d580$export$9547aaa2e39030ff).Disconnected, "Cannot connect to new Peer after disconnecting from server.");
              return;
          }
  	 ...
  	 */ call(peer, stream, options = {}) {
          if (this.disconnected) {
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).warn("You cannot connect to a new Peer because you called .disconnect() on this Peer and ended your connection with the server. You can create a new Peer to reconnect.");
              this.emitError(($edbcf3072a01d580$export$9547aaa2e39030ff).Disconnected, "Cannot connect to new Peer after disconnecting from server.");
              return;
          }
          if (!stream) {
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).error("To call a peer, you must provide a stream from your browser's `getUserMedia`.");
              return;
          }
          const mediaConnection = new ($0bc12d7ac26e1491$export$4a84e95a2324ac29)(peer, this, {
              ...options,
              _stream: stream
          });
      ...
      /** Add a data/media connection to this peer. */ _addConnection(peerId, connection) {
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`add connection ${connection.type}:${connection.connectionId} to peerId:${peerId}`);
  	 ...
  	 */ _abort(type, message) {
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).error("Aborting!");
  	 ...
  	 */ destroy() {
          ...
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`Destroy peer with ID:${this.id}`);
          this.disconnect();
          this._cleanup();
  	 ...
  	 */ disconnect() {
          ...
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`Disconnect peer with ID:${currentId}`);
          this._disconnected = true;
          this._open = false;
          this.socket.close();
  	 ...
  	 */ reconnect() {
          if (this.disconnected && !this.destroyed) {
              ($d3fc3aacca52312c$export$2e2bcd8739ae039).log(`Attempting reconnection to server with ID ${this._lastServerId}`);
              this._disconnected = false;
              this._initialize(this._lastServerId);
          } else if (this.destroyed) throw new Error("This peer cannot reconnect to the server. It has already been destroyed.");
          else if (!this.disconnected && !this.open) // Do nothing. We're still connecting the first time.
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).error("In a hurry? We're still trying to make the initial connection!");
  	 ...
  	 * your key.
  	 */ listAllPeers(cb = (_)=>{}) {
          this._api.listAllPeers().then((peers)=>cb(peers)).catch((error)=>this._abort(($edbcf3072a01d580$export$9547aaa2e39030ff).ServerError, error));
      }
      constructor(id, options){
          super(), this._serializers = {
              raw: ($6faa8477ae391a66$export$6f88fe47d32c9c94),
              json: ($b524315f5ff1ee78$export$48880ac635f47186),
              binary: ($6b2c8b37149b9a13$export$f0a5a64d5bb37108),
              "binary-utf8": ($6b2c8b37149b9a13$export$f0a5a64d5bb37108),
              default: ($6b2c8b37149b9a13$export$f0a5a64d5bb37108)
          ...
          options = {
              debug: 0,
              host: ($01f0d223090cb1f8$export$7debb50ef11d5e0b).CLOUD_HOST,
              port: ($01f0d223090cb1f8$export$7debb50ef11d5e0b).CLOUD_PORT,
              path: "/",
              key: $11967427976ce06d$export$ecd1fc136c422448.DEFAULT_KEY,
              token: ($01f0d223090cb1f8$export$7debb50ef11d5e0b).randomToken(),
              config: ($01f0d223090cb1f8$export$7debb50ef11d5e0b).defaultConfig,
          ...
          if (this._options.secure === undefined && this._options.host !== ($01f0d223090cb1f8$export$7debb50ef11d5e0b).CLOUD_HOST) this._options.secure = ($01f0d223090cb1f8$export$7debb50ef11d5e0b).isSecure();
          else if (this._options.host == ($01f0d223090cb1f8$export$7debb50ef11d5e0b).CLOUD_HOST) this._options.secure = true;
          // Set a custom log function if present
          if (this._options.logFunction) ($d3fc3aacca52312c$export$2e2bcd8739ae039).setLogFunction(this._options.logFunction);
          ($d3fc3aacca52312c$export$2e2bcd8739ae039).logLevel = this._options.debug || 0;
          this._api = new ($4c932c6613316196$export$2c4e825dc9120f87)(options);
          this._socket = this._createServerConnection();
          // Sanity checks
          // Ensure WebRTC supported
          if (!($01f0d223090cb1f8$export$7debb50ef11d5e0b).supports.audioVideo && !($01f0d223090cb1f8$export$7debb50ef11d5e0b).supports.data) {
              this._delayedAbort(($edbcf3072a01d580$export$9547aaa2e39030ff).BrowserIncompatible, "The current browser does not support WebRTC");
              return;
          }
          // Ensure alphanumeric id
          if (!!userId && !($01f0d223090cb1f8$export$7debb50ef11d5e0b).validateId(userId)) {
              this._delayedAbort(($edbcf3072a01d580$export$9547aaa2e39030ff).InvalidID, `ID "${userId}" is invalid`);
              return;
          }
          if (userId) this._initialize(userId);
          else this._api.retrieveId().then((id)=>this._initialize(id)).catch((error)=>this._abort(($edbcf3072a01d580$export$9547aaa2e39030ff).ServerError, error));
      }
  }
  ...
  /** @deprecated Should use peerjs namespace */ window.Peer = ($11967427976ce06d$export$ecd1fc136c422448);
